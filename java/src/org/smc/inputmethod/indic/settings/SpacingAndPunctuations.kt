...
class SpacingAndPunctuations private constructor(
    ...
    fun dump(): String = buildString {
        append("mSortedSymbolsPrecededBySpace = ")
        append(Arrays.toString(mSortedSymbolsPrecededBySpace))
        append("\n   mSortedSymbolsFollowedBySpace = ")
        append(Arrays.toString(mSortedSymbolsFollowedBySpace))
        append("\n   mSortedWordConnectors = ")
        append(Arrays.toString(mSortedWordConnectors))
        append("\n   mSortedWordSeparators = ")
        append(Arrays.toString(mSortedWordSeparators))
        append("\n   mSuggestPuncList = ")
        append(mSuggestPuncList)
        append("\n   mSentenceSeparator = ")
        append(mSentenceSeparator)
        append("\n   mSentenceSeparatorAndSpace = ")
        append(mSentenceSeparatorAndSpace)
        append("\n   mCurrentLanguageHasSpaces = ")
        append(mCurrentLanguageHasSpaces)
        append("\n   mUsesAmericanTypography = ")
        append(mUsesAmericanTypography)
        append("\n   mUsesGermanRules = ")
        append(mUsesGermanRules)
    }
}
