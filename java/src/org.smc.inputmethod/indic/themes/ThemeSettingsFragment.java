...
import org.smc.inputmethod.indic.themes.RadioButtonPreference;
import org.smc.inputmethod.indic.themes.RadioButtonPreference.OnRadioButtonClickedListener;
...
public final class ThemeSettingsFragment extends SubScreenFragment
    ...
    public void onCreate(final Bundle icicle) {
        ...
        for (int index = 0; index < keyboardThemeNames.length; index++) {
            ...
            System.out.println(keyboardThemeNames[index]);
